...
### Base Mainnet
```
ERC8004_IDENTITY_REGISTRY              = (update after deploy)
ERC8004_REPUTATION_REGISTRY            = (update after deploy)
IDENTITY_REGISTRY_DEPLOYMENT_TX_HASH  = (update after deploy)
REPUTATION_REGISTRY_DEPLOYMENT_TX_HASH= (update after deploy)
```
